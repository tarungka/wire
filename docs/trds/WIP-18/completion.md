...
| Node configuration, CLI and environment defaults | `state.default_backend`, HashMap/Pebble subsettings, both documented CLI flags, documented environment names and precedence need implementation/verification. |
