...
- **Remaining:** Backend selection through system config/CLI/SDK, cluster state integration, checkpoint transport/retention, rescaling, and comparative benchmarks remain incomplete; coordinator Pebble metadata is separate. This proposal is not yet complete.
