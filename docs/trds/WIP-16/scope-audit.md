...
| HTTP ingress/delivery | Existing auth/TLS, bounded ingress, retry/idempotency tests | Full SDK/cluster acceptance, especially permanent HTTP errors through a named DLQ |
