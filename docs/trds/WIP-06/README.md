...
2. **May differ:** `parallelism` per operator (Key Groups are redistributed per WIP-03).
...
| 3 | Risk: Source offsets are connector-specific. Need a polymorphic schema. | — | Acknowledged |
