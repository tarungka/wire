...
- **Implemented:** WIP-20, WIP-21, WIP-22, WIP-24, WIP-25.
- **Partially Implemented:** WIP-01 through WIP-19, WIP-23.

## Near-term focus (in priority order)

1. **Make the supported execution contract explicit.** Validate linear cluster graph shapes and reject unsupported pause/restore operations until implemented (WIP-15). Task initialization, cleanup, and status reporting are implemented under WIP-20.
