...
const file_message_proto_rawDesc = "" +
	"\n" +
	"\rmessage.proto\x12\acluster\x1a$internal/command/proto/command.proto\"E\n" +
	"\vCredentials\x12\x1a\n" +
	"\busername\x18\x01 \x01(\tR\busername\x12\x1a\n" +
	"\bpassword\x18\x02 \x01(\tR\bpassword\"?\n" +
	"\bNodeMeta\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12!\n" +
	"\fcommit_index\x18\x02 \x01(\x04R\vcommitIndex\"\xab\b\n" +
	"\aCommand\x12)\n" +
	...
	"\vcredentials\x18\x04 \x01(\v2\x14.cluster.CredentialsR\vcredentials\"\xca\x02\n" +
	"\x04Type\x12\x18\n" +
	"\x14COMMAND_TYPE_UNKNOWN\x10\x00\x12!\n" +
	"\x1dCOMMAND_TYPE_GET_NODE_API_URL\x10\x01\x12\x18\n" +
	...
	"\x06leader\x18\x02 \x01(\tR\x06leaderB(Z&github.com/tarungka/wire/cluster/protob\x06proto3"
